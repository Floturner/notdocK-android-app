...
public class PartenairesDossierActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_partenaires_dossier);

        listPartenaires = findViewById(R.id.partenaires_dossier_list);

        Intent intent = getIntent();
        if (intent != null) {
            allPartenairesOnDossier = (List<Partenaire>) intent.getSerializableExtra("listPartenairesDossier");
            PartenaireAdapter adapter = new PartenaireAdapter(PartenairesDossierActivity.this, allPartenairesOnDossier);
