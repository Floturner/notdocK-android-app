...
public class ClientsDossierActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clients_dossier);

        listClients = findViewById(R.id.clients_dossier_list);

        Intent intent = getIntent();
        if (intent != null) {
            allClientsOnDossier = (List<Client>) intent.getSerializableExtra("listClientsDossier");
            ClientAdapter adapter = new ClientAdapter(ClientsDossierActivity.this, allClientsOnDossier);
